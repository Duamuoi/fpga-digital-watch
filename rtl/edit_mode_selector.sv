...
assign enable_counter = (armed === 1'b1) && press;
assign reset_counter  = (armed !== 1'b1) || disarm;

// Disarm on the press that steps past the last mode
assign disarm = (armed === 1'b1) && press && (count == 2'd2);

// Output logic
assign mode_enable = (armed === 1'b1) ? (3'b001 << count) : 3'b000;
